...
export const activateUserCompte = ({ email, userType, token, lang }) => {
  return {
    html: `
       <!DOCTYPE html>
            <html lang="${lang}">
                              ...
                              <td style="width: 100%; color: #888; text-align: center">
                                <table style="width: 100%; padding: 1rem 0">
                                  <tr>
                                    ...
                                    >
                                      Vous avez demandez l'activation de votre compte (<span style="color: #036eff">${email}</span
                                      >) en tant
                                      <span
                                        >${
                                          userType === "client"
